...
dat = subj_dat;
[individualparams, ~]=subplex('model_Perceptual_CorrelatedNoise', starting_pt);
% optimise again, just to make sure we are at the minimum
[subj_params,subj_NlogL] = fminsearchbnd(@(individualparams) model_Perceptual_CorrelatedNoise(individualparams),individualparams,[0,-1000,-1000, 0],[80,1000,1000, 1],options);
end