...
dat = subj_dat;
[individualparams, ~]=subplex('model_Perceptual_Shift', starting_pt);
% optimise again, just to make sure we are at the minimum
[subj_params,subj_NlogL] = fminsearchbnd(@(individualparams) model_Perceptual_Shift(individualparams),individualparams,[0,-1000,-1000, -1000],[80,1000,1000, 1000],options);
end